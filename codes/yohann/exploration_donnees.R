...
## data_claim0
### si plusieurs sinistre pour un indiv. parfois il y a des trop payés qui sont reverses 
### à l'assurance comme là (ça cré sinistre negatifs parfois)
...
data_claim0[which(data_claim0$id_client == "A00003988"),] ## somme des sinistres est négative sur 1 an


### on voit ici que 1 ligne = 1 id_client, 1 id_vehicule, 1 id_claim (faudrait regrouper comme ça)
...
########## construction des base d'étude

## base pour étude frequence
